...
import waste from '../assets/waste.png'; // Ensure these are imported
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <nav className="bg-white shadow-md fixed top-0 left-0 right-0 z-50">
        <div className="mx-auto flex justify-between items-center h-20 px-4 sm:px-20">
          ...
          <ul className="hidden md:flex items-center space-x-10">
            ...
            <li>
              <a href="#about" className="text-gray-800 font-semibold hover:text-blue-700 transition duration-300">
                About
              </a>
            </li>
            <li>
              <a href="#contact" onClick={scrollToContact} className="text-gray-800 font-semibold hover:text-blue-700 transition duration-300">
                Contact
              </a>
            </li>
          </ul>
      ...
      <div className="pt-20">
        ...
        <div className="w-full mx-auto py-16 space-y-10 px-4 sm:px-20 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="200">
              <Link to="/signup" className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <section className="py-16 bg-white">
          <div id="about" className="max-w-8xl mx-auto px-4 sm:px-20" data-aos="fade-right">
