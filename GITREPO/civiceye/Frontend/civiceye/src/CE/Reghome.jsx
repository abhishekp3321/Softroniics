    ...
    <div class="mx-auto flex justify-between items-center h-20 px-20">
      ...
      <img src={male}></img>
        ...
        <div class="w-full  mx-auto py-10 space-y-10">
          ...
          <div class="px-24 py-30 mx-40 rounded-4xl shadow-2xl ">
            <div class="text-3xl font-bold text-center mb-5">Register Complaints</div>
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
              <div class="bg-white p-8 justify-center items-center cursor-pointer hover:bg-blue-200 rounded-lg shadow-md">
                <div class="flex justify-center">
                  <img src={waste} alt="Waste Dumping" />
                </div>
                <div class="block text-gray-800 text-center mt-5 font-semibold ">Waste Dumping</div>
              </div>
              <div class="bg-white p-8 cursor-pointer  hover:bg-blue-200 rounded-lg shadow-md">
                <div class="flex justify-center">
                  <img src={alert} alt="Public Nuisance" />
                </div>
                <div class="block text-gray-800 text-center mt-5 font-semibold">Public Nuisance</div>
              </div>
              <div class="bg-white p-8 cursor-pointer hover:bg-blue-200 rounded-lg shadow-md">
                <div class="flex justify-center">
                  <img src={traffic} alt="Traffic Violations" />
                </div>
                <div class="block text-gray-800 text-center mt-5 font-semibold">Traffic Violations</div>
              </div>
              <div class="bg-white p-8 cursor-pointer hover:bg-blue-200  rounded-lg shadow-md">
                <div class="flex justify-center">
                  <img src={others} alt="Others" />
                </div>
                <div class="block text-gray-800 text-center mt-5 font-semibold">Others</div>
              </div>
            </div>
          </div>
            ...
            <div class=" text-center">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white py-20 h-90 cursor-pointer hover:bg-blue-200 rounded-lg shadow">
                  ...
                  <h3 class="text-lg font-bold">Reports Filed</h3>
                ...
                <div class="bg-white py-20 h-90 cursor-pointer hover:bg-blue-200 rounded-lg shadow">
                  ...
                  <h3 class="text-lg font-bold">Rewards Distributed</h3>
