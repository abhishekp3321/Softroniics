    ...
    <div className="flex w-full">
      <div className="bg-white w-96 min-h-screen p-4 ">
        ...
        <div className="space-y-7 py-10">
          ...
          <button className="bg-[#00b9ff]  p-4 justify-start flex font-medium   w-64 hover:text-white rounded-lg ">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full bg-white  rounded-lg">
              <thead class="bg-gray-100 shadow-xl">
                <tr>
                  <th class="px-6 py-3 text-left text-2xl font-medium text-black ">Date</th>
                  <th class="px-6 py-3 text-left text-2xl font-medium text-black">Description</th>
                  <th class="px-6 py-3 text-left text-2xl font-medium text-black">Location</th>
                  <th class="px-6 py-3 text-left text-2xl font-medium text-black ">Uploader</th>
                  <th class="px-6 py-3 text-left text-2xl font-medium text-black ">Type</th>
                  <th class="px-6 py-3 text-center text-2xl font-medium text-black">Submission</th>
                </tr>
              </thead>
              <tbody>
                <tr class="">
                  <td class="px-6 py-4 text-xl text-black ">01-01-2012</td>
                  <td class="px-6 py-4 text-xl text-black ">Waste Dumping</td>
                  <td class="px-6 py-4 text-xl text-black ">Kozhikode</td>
                  <td class="px-6 py-4 text-xl text-black ">Milan</td>
                  <td class="px-6 py-4 text-xl text-black ">Waste</td>
